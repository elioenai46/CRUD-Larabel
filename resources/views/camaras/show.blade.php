...
<body>
    @extends('insert') {{-- Asegúrate de que la vista use la estructura correcta, en este caso, 'insert' --}}

    @section('content')
        <div class="login-box">
            <h2>Editar Camara</h2>
            <form action="{{route('camaras-update',['id' => $camara->id])}}" method="POST">
                ...
                <div class="user-box">
                    <input type="number" name="peso" value="{{ $camara->peso }}" required>
                    <label>Peso</label>
                </div>
                <div class="user-box">
                    <input type="number" name="precio" value="{{ $camara->precio }}" required>
                    <label>Precio</label>
                </div>
...
{{-- Siempre que se habra una seccion debemos utilizar end section --}}
